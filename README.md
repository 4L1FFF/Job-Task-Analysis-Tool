...
🚀 Getting Started
Load Data - Upload an Excel file with sheets named: System, Product, JobRole

Process Database - Click "Process Excel" to build your database

Switch to User Panel - Navigate to the User view

Apply Filters - Select criteria using cascading dropdowns

Export Results - Download learning plans or skill lists
...
Open jtat_app.html in your browser
